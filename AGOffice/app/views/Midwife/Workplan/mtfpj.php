...
<div class='col-md-10'>
    <div class="row mt-5">
        ...
        <div class="col-md-3">
            ...
            <form action="<?=PROOT?>Workplan/seeMonthReports/mtfpj" method="post">
    ...
    <form action="<?=PROOT?>Workplan/saveMode/mtfpj" method="post" style="display:block;width:100%">
                ...
                <div class="col-12 mt-5 page-content" style="padding: 5px 20px;">
                    ...
                    <div class="row">
                        <div class="col-4 tab-text">
                            ...
                            <div class="row">
                                <div class="col-12 heading">
                                    <p>4. මාතෘ සං‍රක්ෂනය(ප්‍රථම පසු ප්‍රසව ගමනේදී)</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 not-heading">
                                    <p>ගර්භණී සමයේ රෝගී තත්ත්වයන් වාර්තා කළ මව්වරු ගණන</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-5 not-heading-multi" style="padding-top: 20px;">
                                    <p>අධිරුධිර පීඩනය</p>
                                </div>
                                <div class="col-7">
                                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 not-heading">
                                    <p>තයිරොයිඩ් ග්‍රන්ථිය ආශ්‍රිත රෝග</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 not-heading">
    ...
    <?php if(!$this->editMode & ($this->period ==date('Y-m'))){
                   ...
                   ?>
    <form action="<?=PROOT?>Workplan/editMode/mtfpj" method="post">
