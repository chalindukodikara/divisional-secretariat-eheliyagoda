    ...
    <div class="messaging">
        <div class="inbox_msg">
                ...
                <div class="headind_srch">
                    ...
                    <div class="srch_bar">
                        <div class="stylish-input-group">
                            <form action="<?= PROOT ?>medicalofficer/searchForMessage" method="POST">
                ...
                <div class="inbox_chat">
                            ...
                            <div class="chat_people">
                                ...
                                <div class="chat_ib">
                                    <?php if (User::currentUser()->idcardnum == $chat->idcardnum) : ?>
                                        ...
                                        <div class="text-right" style="width: 100%;"><a href="<?= PROOT ?>medicalofficer/message/<?= $chat->sender; ?>">view</a></div>
                                    <?php else : ?>
                                        <h5><?= $chat->sender_name ?><span class="chat_date"><?= Helper::time_elapsed_string($chat->date); ?></span></h5>
                                        <p>You: <?= $chat->message ?></p>
                                        <div class="text-right" style="width: 100%;"><a href="<?= PROOT ?>medicalofficer/message/<?= $chat->idcardnum; ?>">view</a></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <?php foreach ($this->users as $user) : ?>
                        <div class="chat_list active_chat">
                            ...
                            <a href="<?= PROOT ?>medicalofficer/message/<?= $user->idcardnum; ?>">view</a>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="mesgs">
                ...
                <h3><?php if(isset($this->activeChat)):?>
                ...
                <div class="type_msg">
                    <form action="<?= PROOT ?>medicalofficer/message/<?= $this->activeChat; ?>" method="POST">
